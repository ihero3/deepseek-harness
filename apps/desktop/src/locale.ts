...
export const en = {
  ...
  aboutMenu: 'About Deepseek Harness for Threerouter',
  edit: 'Edit',
  ...
  startupFailed: 'Deepseek Harness for Threerouter is unavailable',
  ...
  updateDownloadedTitle: 'Deepseek Harness for Threerouter v{version} downloaded',
  ...
  updateTitle: 'Deepseek Harness for Threerouter Update',
  updateAvailable: 'An update is available',
  updateDetail: 'Deepseek Harness for Threerouter {version}\n\nThis release includes its matching dsh version. The application will restart after installation.',
...
export const zh = {
  application: '应用',
  aboutMenu: '关于 Deepseek Harness for Threerouter',
  edit: '编辑',
  menuBar: '应用菜单',
  delete: '删除',
  undo: '撤销',
  ...
  paste: '粘贴',
  selectAll: '全选',
  startupFailed: 'Deepseek Harness for Threerouter 无法使用',
  ...
  updateDownload: '下载更新',
  updateDownloadedTitle: 'Deepseek Harness for Threerouter v{version} 下载完成',
  ...
  updateTitle: 'Deepseek Harness for Threerouter 更新',
